...
So, she got the permalink to the episode on the slate website and she actually was willing to listen to it, albeit later (understandably, as I pointed out above). She was probably sitting in front of her Windows PC, received the link to the episode website on her iPhone. She didn't necessarily want to subscribe to the whole feed. She wanted to download the episode now, upon receiving the link, for when she was on her way home.  
...
* For a 20 minutes episode it might be almost feasible, but listening to a longer audio track in a mobile browser, pre-loading the episode while on WiFi is **at best** an enormous hassle. 
* Dropping the linked mp3 file in Dropbox doesn't work, either. I felt very clever and tried, but this kind of thing on iOS only seems to work with .pdf files (it also would be a hassle and would require the Dropbox app). 
* The *Working* podcast is hosted on SoundCloud. I suppose the SoundCoud app is **a** possibility. Still would require downloading an app and doesn't apply to all podcasts. People's willingness to download one app per podcast might be the only thing lower than downloading one dedicated podcast app.

So, we see the link to the episode at best helps in regard of letting my sister decide if she wants to listen to the episode or not. Like a frikkin program guide from the 80s. When it comes to listening **through** the episode, there's nothing. The options listed above all were de duds. We have to take a step back and take a look at the podcast as a whole.

## Sub!Scribe!To!Me!
The next best thing would be to grab the RSS link and subscribe to the podcast proper. Imagine you had to subscribe to all the YouTube feeds you want to see **one** video from. 'Subscribe' is a big word! I don't blame anybody who shys away from that kind of commitment. But for the sake of this post let's say you feel crazy today and are fine with subscribing to this podcast you **haven't even heard a full episode of yet**.  
This isn't trivial at all. The user needs to a) find the RSS link on the website and then b) know just to **copy** the RSS link and then c) drop it into his podcast app of choice that d) needs to be on the phone already or is to be bought/downloaded beforehand. If the user instead just taps on the RSS feed address, they're at the mercy of the OS.

iOS 8 comes with Apple's own podcast app, so in that case they're kind of lucky. Android just displays the raw RSS feed (your average user just **freaked out**).

*Quick aside*: This is a thing the [Podlove project's Subscribe Button](http://podlove.org/podlove-subscribe-button/) tries to fix. It sits on a podcast's website and presents the appropriate options of subscribing to the podcast to the user. Check it out on [ungeheuerlich.org](http://www.ungeheuerlich.org/)!

So, to be clear: I don't think anybody makes it this far without **really** wanting to listen to the episode, **or** being really committed and still having somebody explain the whole thing to them.

## App Good, All Good?
I recommended a podcast app to my sister ([Castro](https://itunes.apple.com/de/app/castro-high-fidelity-podcasts/id723142770?mt=8), for its slickness – I myself prefer [Overcast](https://itunes.apple.com/de/app/overcast-podcast-player/id888422857?mt=8)), so she didn't use Apple's but still was able to go ahead. Reminder: Interacting with a whole new kind of app, is always a big hurdle for most users.

Should be easy now, right? Again, wrong. What's next?  
Either by having grabbed the feed URL from the *Working* episode site, or by searching for the podcast within the app (remembering the name and then **manually** typing it, mind you!) my sister subscribed to the feed. Phew!  

The average podcast app now would go and download only the most recent episode. While this is perfectly reasonable, this again isn't what my sister wanted. She had to go in, delete that most current one and then skim through the feed to find the episode I originally recommended to her (The farmer, remember? Me neither). For shows with huge backlogs, finding an older episode is real hassle. 

Success! Kind of. To be honest: Recommending podcasts or specific episodes to not-yet listeners seems almost offensive to me at this point. 
...
Maybe a search function within a single podcast's feed, to make huge backlogs more manageable, is feasible.  
Of course, there's the idea of chapter marks out there, and in some way there are time stamps in Overcast links. All of this adds to discoverability and such, but [chapter marks don't spread that well](http://www.marco.org/2015/01/03/overcast-chapter-support) and Overcast's timestamps were broken for me when I tried to use them. Besides that, none of that alone would have a profound impact I think.
...
Anyway, I hope something happens in this regard. I hope this article helps to identify problems that keep podcasting back. There is so much great content out there in podcast form, it would be a real bummer if we can't figure out how to make it more accessible for everyone. Thank you.